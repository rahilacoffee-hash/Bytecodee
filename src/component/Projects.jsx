  ...
  useEffect(() => {
    ...
    function onMove(e) {
      ...
      cards.forEach((card) => {
        ...
        let intensity =
          dist <= SPOTLIGHT_RADIUS * 0.5
            ? 1
            : dist <= SPOTLIGHT_RADIUS * 0.75
              ? (SPOTLIGHT_RADIUS * 0.75 - dist) / (SPOTLIGHT_RADIUS * 0.25)
              : 0;
      ...
      let targetOpacity =
        minDist <= SPOTLIGHT_RADIUS * 0.5
          ? 0.85
          : minDist <= SPOTLIGHT_RADIUS * 0.75
            ? ((SPOTLIGHT_RADIUS * 0.75 - minDist) /
                (SPOTLIGHT_RADIUS * 0.25)) *
              0.85
            : 0;
      gsap.to(spotlight, {
  ...
  return (
    <div
      ...
      style={{
        ...
        background:
          "linear-gradient(135deg, rgba(132,0,255,0.1) 0%, rgba(74,222,128,0.05) 60%, rgba(255,255,255,0.02) 100%)",
    ...
    >
      ...
      {image ? (
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center gap-2">
          ...
          >
            <FiExternalLink
              size={18}
              style={{ color: "rgba(132,0,255,0.5)" }}
            />
          </div>
          <p
            style={{
      ...
      {/* Shimmer on hover */}
      <div
        className="proj-card-shimmer absolute inset-0 pointer-events-none"
        style={{
          background:
            "linear-gradient(105deg, transparent 40%, rgba(132,0,255,0.08) 50%, transparent 60%)",
      ...
      <div className="flex flex-col flex-1 p-5">
        <div className="flex items-start justify-between mb-3">
          ...
          <div className="flex gap-1.5">
            {[
              { href: project.github, Icon: FiGithub, hoverColor: "#fff" },
              {
                href: project.live,
                Icon: FiArrowUpRight,
                hoverColor: "#4ade80",
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(132,0,255,0.08) 0%, transparent 70%)",
          top: "15%",
          right: "5%",
        }}
      />
      ...
      {/* Vertical label */}
      <div
        className="absolute right-0 top-1/2 -translate-y-1/2 flex flex-col items-center gap-3 pr-4"
        style={{ zIndex: 2 }}
      >
        <div className="w-px h-24 bg-white/20" />
        <span
          className="text-[11px] font-medium tracking-[0.18em] uppercase text-white/40"
