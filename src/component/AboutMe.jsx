    ...
    >
      ...
      <div className="flex-1 flex flex-col lg:flex-row gap-12 lg:gap-20 items-start">
        ...
        <div className="flex-1 flex flex-col justify-between h-full">
          <h2
            className="font-bold uppercase leading-[0.9] tracking-tighter text-white mb-10"
          ...
          <div className="flex flex-wrap gap-2">
            {content.tags.map((tag) => (
              <span
                key={tag}
                className="flex items-center gap-1.5 text-[12px] rounded-full px-3 py-1.5 cursor-default"
                style={{
        ...
        {/* RIGHT — Value card */}
        <div
          className="w-full lg:w-80 rounded-2xl overflow-hidden flex flex-col shrink-0"
          style={{
            background: "rgba(255,255,255,0.04)",
        ...
        >
          ...
          <div
            ...
            style={{ height: "220px", background: "#0d0d1a" }}
          >
            <img
          ...
          <div className="px-5 py-5 flex-1">
            ...
            >
              I combine design systems, rapid prototyping, and real-world user
              research to deliver products that scale. Every project is built
      ...
      {/* Bottom row */}
      <div
        className="flex items-end justify-between mt-16 pt-6 border-t"
        style={{ borderColor: "rgba(255,255,255,0.08)" }}
      >
        <div className="flex flex-col gap-1">
          <p className="text-[13px]" style={{ color: "rgba(255,255,255,0.4)" }}>
            E abrahamfred123@gmail.com
          </p>
          <p className="text-[13px]" style={{ color: "rgba(255,255,255,0.4)" }}>
            T +234 912 124 9422
          </p>
